...
namespace SampleCourier.WebApi.Controllers
{
	...
	public class ExecController : Controller
	{
		...
		public async Task<IActionResult> Get()
		{
			...
			{
				var items = await dbCtx.Set<RoutingSlipState>().Take(10)
...
";
				var res = await dbCtx.Database.ExecuteSqlCommandAsync(sql);
		...
		private string GetUrlStr(int id)
		{
			...
			{
				case 0:
					return "http://www.microsoft.com/index.html";
				case 1:
					return "http://i.imgur.com/Iroma7d.png";
				case 2:
					return "http://i.imgur.com/NK8eZUe.jpg";
				default:
					return null;
			}
		}
